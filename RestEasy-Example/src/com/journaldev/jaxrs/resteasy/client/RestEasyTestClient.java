...
public class RestEasyTestClient {
	public static void main(String[] args) {
		...
		// get exemple
		ResteasyWebTarget getDummy = client.
				target("http://localhost:8084/RestEasy-Example/employee/99/getDummy");
		...
		// Post example
		ResteasyWebTarget add = client.target("http://localhost:8084/RestEasy-Example/employee/add");
		...
		// ira retornar o code 422 - caso o emp existir
		...
		// Delete
		ResteasyWebTarget delete = client.target("http://localhost:8084/RestEasy-Example/employee/50/delete");
